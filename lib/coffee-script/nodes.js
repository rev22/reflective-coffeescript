...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Code, CodeFragment, Comment, Existence, Expansion, Extends, For, HEXNUM, IDENTIFIER, IS_REGEX, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, NEGATE, NO, NUMBER, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, compact, del, ends, extend, flatten, fragmentsToText, isComplexOrAssignable, isLiteralArguments, isLiteralThis, locationDataToSource, locationDataToString, merge, multident, parseNum, ref1, ref2, some, starts, throwSyntaxError, unfoldSoak, utility,
  ...
  exports.Literal = Literal = (function(superClass1) {
    ...
    Literal.prototype.isGlobal = function() {
      var ref3;
      return (ref3 = this.global) != null ? ref3 : 0;
    };
  ...
  exports.GlobalLiteral = (function(superClass1) {
    extend1(GlobalLiteral, superClass1);
        ...
        (function(_this) {
          return (function(val) {
            if (IDENTIFIER.test(val)) {
              if (!(_this.notVar || val === 'this' || o.scope.check(val))) {
  ...
  exports.Assign = Assign = (function(superClass1) {
    ...
    Assign.prototype.compileNode = function(o) {
      var answer, compiledName, isValue, j, maybestrict, name, properties, prototype, ref3, ref4, ref5, ref6, ref7, val, varBase;
    ...
    Assign.prototype.compileTransignment = function(o) {
      var a, acc, answer, b, compiledName, idx, match, maybestrict, name, ref3, ref4, val, varBase, x, y;
      x = this.context;
      a = this.variable;
      b = this.value;
      if (x === '>.') {
      ...
      if (x === '.<') {
        ...
        if (b instanceof Code && (match = METHOD_DEF.exec(name))) {
          ...
          b.name = (ref3 = (ref4 = match[3]) != null ? ref4 : match[4]) != null ? ref3 : match[5];
        }
  ...
  exports.Code = Code = (function(superClass1) {
    ...
    Code.prototype.compileNode = function(o) {
      var answer, boundfunc, code, exprs, i, j, k, l, lecode, len1, len2, len3, len4, len5, len6, len7, lit, m, nam, p, param, params, q, r, ref, ref3, ref4, ref5, ref6, ref7, ref8, ref9, s, splats, uniqs, val, wasEmpty, wrappedCode, wrapper;
      ...
      for (i = q = 0, len5 = params.length; q < len5; i = ++q) {
        p = params[i];
        if ((nam = p != null ? (ref9 = p.base) != null ? ref9.value : void 0 : void 0) != null) {
      ...
      for (i = s = 0, len7 = params.length; s < len7; i = ++s) {
        p = params[i];
        if (i) {
          answer.push(this.makeCode(", "));
        }
