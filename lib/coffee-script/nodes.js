// Generated by Reflective CoffeeScript 1.6.2
(function() {
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.compileNode = function(o) {
      var answer, compiledName, isValue, match, maybestrict, name, val, varBase, _ref4, _ref5, _ref6, _ref7;
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      ...
      o.scope = new Scope(o.scope, this.body, this, !!this.reflective);
      ...
      if (!(wasEmpty || this.noReturn)) {
        if (this.body instanceof Value) {
          this.body = new Return(this.body);
        } else {
