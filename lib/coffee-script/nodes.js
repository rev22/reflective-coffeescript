...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Code, CodeFragment, Comment, Existence, Expansion, Extends, For, HEXNUM, IDENTIFIER, IS_REGEX, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, NEGATE, NO, NUMBER, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, compact, del, ends, extend, flatten, fragmentsToText, isComplexOrAssignable, isLiteralArguments, isLiteralThis, locationDataToSource, locationDataToString, merge, multident, parseNum, some, starts, throwSyntaxError, unfoldSoak, utility, _ref, _ref1,
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compileClosure = function(o) {
      var args, argumentsNode, func, jumpNode, meth, parts, _ref2;
      ...
      if (func.isGenerator || ((_ref2 = func.base) != null ? _ref2.isGenerator : void 0)) {
  ...
  exports.Literal = Literal = (function(_super) {
    ...
    Literal.prototype.isGlobal = function() {
      var _ref2;
      return (_ref2 = this.global) != null ? _ref2 : 0;
    };
  ...
  exports.GlobalLiteral = (function(_super) {
    __extends(GlobalLiteral, _super);

    function GlobalLiteral(x) {
      this.global = 1;
      GlobalLiteral.__super__.constructor.call(this, x);
    }
  ...
  exports.Return = Return = (function(_super) {
    ...
    Return.prototype.compileNode = function(o) {
      var answer, exprIsYieldReturn, _ref2;
      answer = [];
      exprIsYieldReturn = (_ref2 = this.expression) != null ? typeof _ref2.isYieldReturn === "function" ? _ref2.isYieldReturn() : void 0 : void 0;
  ...
  exports.Value = Value = (function(_super) {
    ...
    Value.prototype.isSplice = function() {
      var lastProp, _ref2;
      _ref2 = this.properties, lastProp = _ref2[_ref2.length - 1];
      return lastProp instanceof Slice;
    };

    Value.prototype.looksStatic = function(className) {
      var _ref2;
      return this.base.value === className && this.properties.length === 1 && ((_ref2 = this.properties[0].name) != null ? _ref2.value : void 0) !== 'prototype';
    };
    ...
    Value.prototype.cacheReference = function(o) {
      var base, bref, name, nref, _ref2;
      _ref2 = this.properties, name = _ref2[_ref2.length - 1];
    ...
    Value.prototype.compileNode = function(o) {
      ...
      if (o.scope.strict && this.base instanceof Literal && !this.base.isGlobal()) {
        (function(_this) {
          return (function(val) {
  ...
  exports.Range = Range = (function(_super) {
    ...
    Range.prototype.compileVariables = function(o) {
      var isComplex, step, _ref2, _ref3, _ref4, _ref5;
      o = merge(o, {
        top: true
      });
      isComplex = del(o, 'isComplex');
      _ref2 = this.cacheToCodeFragments(this.from.cache(o, LEVEL_LIST, isComplex)), this.fromC = _ref2[0], this.fromVar = _ref2[1];
      _ref3 = this.cacheToCodeFragments(this.to.cache(o, LEVEL_LIST, isComplex)), this.toC = _ref3[0], this.toVar = _ref3[1];
      if (step = del(o, 'step')) {
        _ref4 = this.cacheToCodeFragments(step.cache(o, LEVEL_LIST, isComplex)), this.step = _ref4[0], this.stepVar = _ref4[1];
      }
  ...
  exports.Obj = Obj = (function(_super) {
    ...
    Obj.prototype.compileNode = function(o) {
      var answer, dynamicIndex, hasDynamic, i, idt, indent, join, key, lastNoncom, node, oref, prop, props, value, _i, _j, _k, _len, _len1, _len2, _ref2;
      props = this.properties;
      if (this.generated) {
        for (_i = 0, _len = props.length; _i < _len; _i++) {
          node = props[_i];
      ...
      for (dynamicIndex = _j = 0, _len1 = props.length; _j < _len1; dynamicIndex = ++_j) {
        ...
        if (!(prop instanceof Comment)) {
          if (i < dynamicIndex) {
            ...
            if (prop instanceof Assign) {
              ...
              _ref2 = prop.base.cache(o), key = _ref2[0], value = _ref2[1];
            }
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.determineName = function() {
      ...
      _ref2 = this.variable.properties, tail = _ref2[_ref2.length - 1];
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.isTransignment = function() {
      return /\.[<>]|[<>]\./.test(this.context);
    };

    Assign.prototype.compileNode = function(o) {
      var answer, compiledName, isValue, maybestrict, name, properties, prototype, val, varBase, _i, _ref2, _ref3, _ref4, _ref5, _ref6;
      if (isValue = this.variable instanceof Value) {
        if (this.isTransignment()) {
          return this.compileTransignment(o);
        }
      ...
      if (this.value instanceof Code) {
        ...
        } else if (((_ref4 = this.variable.properties) != null ? _ref4.length : void 0) >= 2) {
          _ref5 = this.variable.properties, properties = 3 <= _ref5.length ? __slice.call(_ref5, 0, _i = _ref5.length - 2) : (_i = 0, []), prototype = _ref5[_i++], name = _ref5[_i++];
          if (((_ref6 = prototype.name) != null ? _ref6.value : void 0) === 'prototype') {
    ...
    Assign.prototype.compileTransignment = function(o) {
      var a, acc, answer, b, compiledName, idx, match, maybestrict, name, val, varBase, x, y, _ref2, _ref3;
      x = this.context;
      a = this.variable;
      b = this.value;
      if (x === '>.') {
      ...
      if (x === '.<') {
        idx = new Literal(b.properties.length ? b.properties[a.properties.length - 1].name.value : b.base.value);
        acc = IDENTIFIER.test(idx.unwrap().value || 0);
        a = new Value(a);
        a.properties.push(new (acc ? Access : Index)(idx));
        if (maybestrict = o.scope.strict) {
          o.scope.strict = false;
        }
        ...
        answer = compiledName.concat(this.makeCode(" = "), val);
        if (o.level <= LEVEL_LIST) {
          return answer;
        } else {
          return this.wrapInBraces(answer);
        ...
        if (b instanceof Code && (match = METHOD_DEF.exec(name))) {
          if (match[2]) {
            b.klass = match[1];
          }
          b.name = (_ref2 = (_ref3 = match[3]) != null ? _ref3 : match[4]) != null ? _ref2 : match[5];
        }
        idx = new Literal(a.properties.length ? a.properties[a.properties.length - 1].name.value : a.base.value);
        acc = IDENTIFIER.test(idx.unwrap().value || 0);
        b = new Value(b);
        b.properties.push(new (acc ? Access : Index)(idx));
        val = b.compileToFragments(o, LEVEL_LIST);
        answer = compiledName.concat(this.makeCode(" = "), val);
        if (o.level <= LEVEL_LIST) {
          return answer;
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.makeScope = function(parentScope) {
      return new Scope(parentScope, this.body, this, null, !!this.pure);
    };

    Code.prototype.compileNode = function(o) {
      var answer, boundfunc, code, exprs, i, lecode, lit, nam, p, param, params, ref, splats, uniqs, val, wasEmpty, wrappedCode, wrapper, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      if (o.noCoffeeMeta && this.reflective) {
        this.pure = true;
        ...
        this.pure = true;
        this.reflective = false;
        wrappedCode = new Code(this.params, this.body, "purefunc");
        wrappedCode.noReturn = this.noReturn;
        boundfunc = new Call(wrapper, [wrappedCode]);
        if (this.ctor) {
          boundfunc = new Block([new Assign(new Value(new Literal(this.name)), boundfunc)]);
        }
        boundfunc.updateLocationDataIfMissing(this.locationData);
        if (this.ctor) {
          o.scope.add(this.name, 'var');
        }
        return boundfunc.compileNode(o);
      }
      if (this.pure) {
  ...
  exports.Splat = Splat = (function(_super) {
    ...
    Splat.compileSplattedArray = function(o, list, apply) {
      var args, base, compiledNode, concatPart, fragments, i, index, last, node, _i, _len;
      index = -1;
  ...
  exports.Op = Op = (function(_super) {
    ...
    Op.prototype.compileYield = function(o) {
      ...
      if (__indexOf.call(Object.keys(this.first), 'expression') >= 0 && !(this.first instanceof Throw)) {
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.compileNode = function(o) {
      var body, bodyFragments, compare, compareDown, declare, declareDown, defPart, defPartFragments, down, forPartFragments, guardPart, idt1, increment, index, ivar, kvar, kvarAssign, last, lvar, name, namePart, ref, resultPart, returnResult, rvar, scope, source, step, stepNum, stepVar, svar, varPart, _ref2, _ref3;
      body = Block.wrap([this.body]);
      _ref2 = body.expressions, last = _ref2[_ref2.length - 1];
      ...
      if (this.step && !this.range) {
        _ref3 = this.cacheToCodeFragments(this.step.cache(o, LEVEL_LIST, isComplexOrAssignable)), step = _ref3[0], stepVar = _ref3[1];
