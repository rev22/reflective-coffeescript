...
(function() {
  ...
  exports.compile = compile = withPrettyErrors(function(code, options) {
    var answer, currentColumn, currentLine, extend, filename, fragment, fragments, header, js, map, merge, newLines, token, tokens, _i, _len;
  ...
  exports["eval"] = function(code, options) {
    var Module, createContext, filename, isContext, js, k, o, r, sandbox, v, _i, _len, _module, _ref, _ref1, _ref2, _ref3, _ref4, _require;
    if (options == null) {
      options = {};
    }
    if (!(code = code.trim())) {
    ...
    if (createContext) {
      ...
      sandbox.__filename = filename = (_ref3 = options.filename) != null ? _ref3 : 'eval';
