...
(function() {
  var CoffeeScript, addHistory, addMultilineHandler, fs, getCommandId, helpers, merge, nodeREPL, path, replDefaults, updateSyntaxError, vm, _ref;
  ...
  _ref = helpers = require('./helpers'), merge = _ref.merge, updateSyntaxError = _ref.updateSyntaxError;
