...
(function() {
  var CoffeeScript, addHistory, addMultilineHandler, fs, getCommandId, helpers, merge, nodeREPL, path, ref, replDefaults, runInContext, updateSyntaxError, vm;
  ...
  ref = helpers = require('./helpers'), merge = ref.merge, updateSyntaxError = ref.updateSyntaxError;
  ...
  replDefaults = {
    ...
    "eval": function(input, context, filename, cb) {
      var Assign, Block, Literal, Value, ast, err, error, js, ref1, referencedVars, result, token, tokens;
