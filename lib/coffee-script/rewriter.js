  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.addImplicitBracesAndParens = function() {
      ...
      return this.scanTokens(function(token, i, tokens) {
        var endImplicitCall, endImplicitObject, forward, inImplicit, inImplicitCall, inImplicitControl, inImplicitObject, newLine, nextTag, offset, prevTag, prevToken, s, sameLine, stackIdx, stackTag, stackTop, startIdx, startImplicitCall, startImplicitObject, startsLine, tag, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
        tag = token[0];
        ...
        if (tag === 'INDENT' && inImplicit()) {
          if (prevTag !== '@>' && prevTag !== '@>*' && prevTag !== '=>' && prevTag !== '->' && prevTag !== '=>*' && prevTag !== '->*' && prevTag !== '[' && prevTag !== '(' && prevTag !== ',' && prevTag !== '{' && prevTag !== 'TRY' && prevTag !== 'ELSE' && prevTag !== '=') {
