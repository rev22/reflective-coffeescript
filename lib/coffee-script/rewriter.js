  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.addImplicitBracesAndParens = function() {
      ...
      return this.scanTokens(function(token, i, tokens) {
        ...
        if (__indexOf.call(IMPLICIT_FUNC, tag) >= 0 && this.indexOfTag(i + 1, 'INDENT') > -1 && this.looksObjectish(i + 2) && !this.findTagsBackwards(i, ['CLASS', 'EXTENDS', 'IF', 'CATCH', 'SWITCH', 'LEADING_WHEN', 'FOR', 'WHILE', 'UNTIL'])) {
          startImplicitCall(i + 1);
        ...
        if (tag === ':') {
          s = (function() {
            var _ref2, _ref3;
            switch (false) {
              case _ref2 = this.tag(i - 1), __indexOf.call(EXPRESSION_END, _ref2) < 0:
                return start[1];
              case (_ref3 = this.tag(i - 2)) !== '@' && _ref3 !== '@@':
                return i - 2;
              default:
                return i - 1;
            }
