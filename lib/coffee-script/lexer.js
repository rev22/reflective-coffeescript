...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.identifierToken = function() {
      ...
      forcedIdentifier = colon || (prev = last(this.tokens)) && (((_ref2 = prev[0]) === '.' || _ref2 === '?.' || _ref2 === '::' || _ref2 === '?::') || !prev.spaced && ((_ref3 = prev[0]) === '@@' || _ref3 === '@'));
      tag = 'IDENTIFIER';
      if (!forcedIdentifier && (__indexOf.call(JS_KEYWORDS, id) >= 0 || __indexOf.call(COFFEE_KEYWORDS, id) >= 0)) {
        tag = id.toUpperCase();
        if (tag === 'THEN' || tag === 'CATCH' || tag === 'FINALLY') {
          this.addImplicitStart(tag);
        } else if (tag === 'WHEN' && (_ref4 = this.tag(), __indexOf.call(LINE_BREAK, _ref4) >= 0)) {
          tag = 'LEADING_WHEN';
        } else if (tag === 'FOR') {
          this.seenFor = true;
        } else if (tag === 'UNLESS') {
    ...
    Lexer.prototype.interpolateString = function(str, options) {
      ...
      while (letter = str.charAt(i += 1)) {
        ...
        if (inner.length) {
          ...
          nested = this.clone().tokenize(inner, {
            line: line,
            column: column,
            rewrite: false
          });
