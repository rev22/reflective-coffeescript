...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.addImplicitIf = function() {
      var i, stack, tok, tokens, ttt;
      stack = [];
      tokens = this.tokens;
      i = tokens.length;
      if (i <= 0) {
      ...
      if (tokens[i - 1] === 'INDENT') {
        return;
      }
      while (tok = tokens[--i]) {
        ttt = tok[0];
        if (!stack.length) {
          if (ttt === 'IF' || ttt === 'WHEN' || ttt === 'UNLESS' || ttt === 'LEADING_WHEN' || ttt === 'CLASS' || ttt === 'WHILE' || ttt === 'CATCH' || ttt === 'TRY' || ttt === 'FINALLY') {
            return;
          }
          if (ttt === 'THEN' || ttt === 'ELSE') {
            break;
          }
        }
        if (ttt === '\n' || ttt === ';' || ttt === 'INDENT' || ttt === 'CODE') {
          break;
      ...
      i++;
      return tokens.splice(i, 0, ['IF', 'IF', tokens[i][2]]);
    };
